document.addEventListener('DOMContentLoaded', () => {
    ...
    const carData = {
        petrol: [
            { id: "golf", name: "VW Golf 1.5 TSI (Benzin)", cons: 6.5, img: "https://images.unsplash.com/photo-1541899481282-d53bffe3c35d?w=800&auto=format&fit=crop" },
            { id: "egea_p", name: "Fiat Egea 1.4 Fire (Benzin)", cons: 7.5, img: "https://images.unsplash.com/photo-1620067347909-bc3f9ea325fa?w=800&auto=format&fit=crop" },
            { id: "egea_d", name: "Fiat Egea 1.3 Multijet (Dizel)", cons: 4.8, img: "https://images.unsplash.com/photo-1620067347909-bc3f9ea325fa?w=800&auto=format&fit=crop" },
            { id: "corolla", name: "Toyota Corolla 1.5 (Benzin)", cons: 6.2, img: "https://images.unsplash.com/photo-1629897048514-3dd7414bc6ce?w=800&auto=format&fit=crop" },
            { id: "megane", name: "Renault Megane 1.3 TCe (Benzin)", cons: 6.8, img: "https://images.unsplash.com/photo-1632822435889-49772bf2eb76?w=800&auto=format&fit=crop" },
            { id: "i20", name: "Hyundai i20 1.4 MPI (Benzin)", cons: 6.9, img: "https://images.unsplash.com/photo-1619767886558-efdf214cdeac?w=800&auto=format&fit=crop" },
            { id: "p2008", name: "Peugeot 2008 1.2 PureTech (Benzin)", cons: 6.1, img: "https://images.unsplash.com/photo-1606611013481-29ef3e6157f4?w=800&auto=format&fit=crop" },
            { id: "focus", name: "Ford Focus 1.5 TDCi (Dizel)", cons: 5.2, img: "https://images.unsplash.com/photo-1551522435-a13afa10f103?w=800&auto=format&fit=crop" },
            { id: "duster", name: "Dacia Duster 1.3 TCe (Benzin)", cons: 7.2, img: "https://images.unsplash.com/photo-1606016159991-bef4b2811455?w=800&auto=format&fit=crop" },
            { id: "octavia", name: "Skoda Octavia 1.5 TSI (Benzin)", cons: 5.6, img: "https://images.unsplash.com/photo-1614051052204-6351ba2136e4?w=800&auto=format&fit=crop" },
            { id: "passat", name: "VW Passat 1.5 TSI (Benzin)", cons: 6.8, img: "https://images.unsplash.com/photo-1609520778163-a1cdbaddbc87?w=800&auto=format&fit=crop" },
            { id: "civic", name: "Honda Civic 1.5 VTEC (Benzin)", cons: 7.2, img: "https://images.unsplash.com/photo-1605810731210-9280dce68b44?w=800&auto=format&fit=crop" },
            { id: "clio", name: "Renault Clio 1.0 TCe (Benzin)", cons: 5.8, img: "https://images.unsplash.com/photo-1616422285623-14bf9162ab27?w=800&auto=format&fit=crop" },
            { id: "qashqai", name: "Nissan Qashqai 1.3 DIG-T (Benzin)", cons: 7.4, img: "https://images.unsplash.com/photo-1698651800040-d9c025da2c88?w=800&auto=format&fit=crop" },
            { id: "tucson", name: "Hyundai Tucson 1.6 T-GDI (Benzin)", cons: 8.5, img: "https://images.unsplash.com/photo-1643213009572-887413bbedea?w=800&auto=format&fit=crop" },
        ...
        ev: [
            ...
            { id: "mg4", name: "MG4 Electric", cons: 16.0, img: "https://images.unsplash.com/photo-1681206103362-f7246522ef87?w=800&auto=format&fit=crop" },
            { id: "ix3", name: "BMW iX3", cons: 18.9, img: "https://images.unsplash.com/photo-1619362310183-b78f0f04c633?w=800&auto=format&fit=crop" },
            { id: "xc40_ev", name: "Volvo XC40 Recharge", cons: 18.5, img: "https://images.unsplash.com/photo-1682330456100-369403884784?w=800&auto=format&fit=crop" },
            { id: "skywell", name: "Skywell ET5", cons: 19.5, img: "https://images.unsplash.com/photo-1593941707882-a5bba14938c7?w=800&auto=format&fit=crop" },
            ...
            { id: "corsa_ev", name: "Opel Corsa Electric", cons: 15.8, img: "https://images.unsplash.com/photo-1662973796587-c0e5a1b32943?w=800&auto=format&fit=crop" },
            { id: "zoe", name: "Renault Zoe", cons: 17.2, img: "https://images.unsplash.com/photo-1610404099516-72f8832a5247?w=800&auto=format&fit=crop" },
